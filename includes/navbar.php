    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <div class="d-flex align-items-center">
        ...
        <a href="<?php echo $path_prefix; ?>cart.php" class="btn btn-primary position-relative px-4">
          ...
          <span id="cartCountBadge" class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger" style="font-size: 0.6rem;"><?php echo cart_item_count($con); ?></span>
        </a>
      </div>
    </div>
  </div>
